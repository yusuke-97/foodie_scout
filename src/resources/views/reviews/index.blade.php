            ...
            <div class="card mb-5">
                    ...
                    <div class="row align-items-center">
                        <div class="col-2">
                            <div class="ratio ratio-1x1">
                                <a href="{{ route('mypage.profile', $review->user->id) }}" class="small-profile-image-container" style="text-decoration: none;">
                        ...
                        <div class="col-10">
                            <a href="{{ route('mypage.profile', $review->user->id) }}" class="d-inline-block" style="text-decoration: none;">
                                <span style="font-weight: bold; color: #000000;" class="user-name me-3">{{ $review->user->name }}</span>
                            </a>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <p class="restaurant-information mb-0">

        ...
        <div class="col-md-5">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-link mt-3 d-flex justify-content-center login-text" href="{{ route('password.request') }}">
                        パスワードをお忘れの場合
                    </a>
                </div>
            </form>
            ...
            <div class="form-group">
                <a class="btn btn-link mt-3 d-flex justify-content-center login-text" href="{{ route('register') }}">
                    新規登録
                </a>
            </div>
